...
**Key Features**
    ...
    Secure Login: Supports multi-factor authentication,google authentication for secure user access.
...
**Key Objectives**
    ...
    Implement cloud storage using Firebase for user-specific data
